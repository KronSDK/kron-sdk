...
>
> **Status: v0.13.3, mainnet.** Read paths and the covenant builders are proven byte-identical to
...
> sompi instead of the mass-safe `COVENANT_DUST` floor — **upgrade if you call any of these without an
> explicit `tokenDust`** — see the [CHANGELOG](CHANGELOG.md).
>
...
npm install @kronsdk/kron-sdk@0.13.3      # or pin an exact version for reproducible builds
```
