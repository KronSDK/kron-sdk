...
> **Status: v0.9.0, testnet (TN10).** Read paths and the covenant builders are proven byte-identical to
...
npm install @kronsdk/kron-sdk@0.9.0       # or pin an exact version for reproducible builds
```
